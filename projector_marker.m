if active_images(ii)
    ...
    if ~type_numbering
        number_ext =  num2str(image_numbers(ii));
    else
        number_ext = sprintf(['%.' num2str(N_slots) 'd'],image_numbers(ii));
    end
...
if size(Ip,3)>1
    ...
    eval(['Ip_' num2str(ii) ' = IIp;']);
    eval(['In_' num2str(ii) ' = 255 - IIp;']);
