% Modified to write out rectified images in lab data format. - 04/01/19
% stereo_gui
...
cell_list{4,1} = {'Rectify the calibration images','rectify_stereo_pair_lab_data;'};
