...
%GINPUT3 Graphical input from mouse.
%   [X,Y] = GINPUT3(N) gets N points from the current axes and returns 
...
%
%   [X,Y] = GINPUT3 gathers an unlimited number of points until the
%   return key is pressed.
% 
%   [X,Y,BUTTON] = GINPUT3(N) returns a third result, BUTTON, that 
