...
Nl = size(l,1); % Length of calib_name* dir listing
Nima_valid = 0;
ind_valid = [];
loc_extension = [];
length_name = size(calib_name,2);

if Nl > 0 % If there is something in the dir listing
    
    for pp = 1:Nl % for 1:length(calib_name* dir listing)
